...
{
    public class EquipmentModelsRepositorySql : ISqlQueryStorage
    {
        private const string Table = "EquipmentModels";
        ...
        public string ByModelId(int id)
        {
            return $@"
                select * from {Table} where ModelId = {id}                
            ";
        }
