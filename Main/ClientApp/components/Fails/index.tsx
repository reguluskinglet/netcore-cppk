...
import * as FailsStore from '../../store/FailsStore'
...
class Fails extends React.Component<Props, State> {
  componentWillMount() {
    this.setState({
      skip: 0,
      limit: 10,
...
const provider = provide((state: ApplicationState) => state.fails, FailsStore.actionCreators)

type Props = typeof provider.allProps

export default provider.connect(Fails)
